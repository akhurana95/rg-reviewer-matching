...
# in addition to controlling the match process and returning the final results.
    ...
    def __init__(self, program_data, candidate_data, places_data=None):
        ...
        except: #inputs might already be dataframes to begin with
        #INPUTS WILL BE DIRECTLY DATAFRAMES NOW
            self.program_data = program_data
            self.candidate_data = candidate_data
            self.places_data = places_data #where the index is the reviewer/program name
